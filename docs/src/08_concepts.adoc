...
_<Aquí se mostraría un diagrama con el modelo de dominio, y una explicación de cada uno.>_

=== Conceptos de Experiencia de Usuario

_<Aquí se hablaría de toda la usabilidad de la aplicación: interfaz, sensaciones...>_
...
Los conceptos de arquitectura serán más indigados en el siguiente apartado. De forma superficial, la arquitectura...
