...
image::<docs\images\DiagramaDespliegue.jpg>[Diagrama de Despliegue]

Motivación::

El sistema se desplegará en la nube de Microsoft Azure que conectará con una Base de Datos creada en MongoDB por distintas motivaciones:

- *Escalabilidad Automática*: Azure permite escalar según la carga de usuarios sin intervención manual.
- *Seguridad*: Azure proporciona cifrado de datos.
