...
La vista de despliegue describe:
 ...
 1. la infraestructura técnica usada para ejecutar tu sistema, con elementos de infraestructura como ubicaciones geográficas, entornos, ordenadores, procesadores, canales y topologías de red, así como otros elementos de infraestructura, y
...
_<explicación en forma de texto>_
