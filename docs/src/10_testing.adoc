...
image::../images/statsGatling100_1.png[]["Distribución de tiempo de respuesta"]
image::../images/statsGatling100_2.png[]["Numero de peticiones por segundo y respuestas por segundo"]
...
*Estado:* {nbsp} *PASSED* (All conditions passed)
