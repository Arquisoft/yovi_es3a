...
The deployment url is: [https://arquisoft.github.io/yovi_es3a/](https://arquisoft.github.io/yovi_es3a/).
...
If we want to deploy it to GitHub pages, so it is accessible via [https://arquisoft.github.io/yovi_es3a/](https://arquisoft.github.io/yovi_es3a/), we need to execute `npm run deploy`.
